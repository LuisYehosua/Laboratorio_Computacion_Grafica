...
glm::vec3 lightPos2(-2.0f, 1.0f, 1.0f);
...
int main()
{
    ...
    Model burger((char*)"Models/burger.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.specular"), 0.3f, 0.6f, 0.6f);
